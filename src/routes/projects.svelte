...
<section class='section' id="projects">
    ...
    <a class="project " href="https://www.github.com" target="_blank">
        <div class="left">
            <img src="./web_scraping.png" alt="Project_image">
        </div>
        <div class="right">
            <h4>Web Scraping</h4>
            <p>Extracting, cleaning and exporting website data to a excel file for easy to utilize data.<br><br>
            Using beautiful soup it is really easy to get data from a site but it takes some time to check for inconsistencies on the site structure and to clean up the data. <br><br>
            By extracting data from the site I'm also able to automate the download of all images on the site to a local folder.
            </p>
            <ul class="techs">
    ...
    <a class="project " href="https://github.com/YoruAlptraum/pit-senai-v2" target="_blank">
        ...
        <div class="right">
            <h4>PIT SENAI</h4>
            <p>The PIT is the final project for the IT course in SENAI. <br><br>
